...
// Reusable NavItem
const SideItem = ({ icon, text, active = false }) => (
  <li
    className={`
      ...
      <div className='flex flex-col items-center gap-10'>
        ...
        <nav>
          <ul className='space-y-5'>
            <SideItem icon={<BsFillGrid1X2Fill />} text='Dashboard' active />
            <SideItem icon={<FaCloudUploadAlt />} text='Upload Voucher' />
            <SideItem icon={<FaFileAlt />} text='Vouchers' />
            <SideItem icon={<MdInsertPageBreak />} text='Mobile Scanner' />
            <SideItem icon={<FaCog />} text='Settings' />
          </ul>
        </nav>
      </div>
